...
export const STOCKS: Stock[] = [
  // ₿ Criptomoedas (12) — logos via CoinGecko CDN público
  {
    symbol: "BTC",
  ...
  {
    symbol: "POL",
    apiSymbol: "BINANCE:POLUSDT",
    name: "Polygon",
    category: "crypto",
    logoUrl: "https://assets.coingecko.com/coins/images/32440/small/polygon.png",
  },
